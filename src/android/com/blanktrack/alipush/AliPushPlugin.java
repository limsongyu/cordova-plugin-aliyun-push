...
import com.alibaba.sdk.android.push.register.FcmRegister;
    ...
    public boolean execute(final String action, final JSONArray args, final CallbackContext callbackContext) throws JSONException {
        ...
        switch (action) {
            ...
            case "init": {
                ...
                String FCMSendId = preferences.getString("FCM_SENDID", "");
                String FCMAppId = preferences.getString("FCM_APPID", "");
                ...
                FcmRegister.register(applicationContext, FCMSendId, FCMAppId);
